...
一句話介紹：把 Telegram 變成你的私人鬧鐘／小管家，使用自然語言就能排「整點」或「每小時」的提醒。後端完全跑在 Cloudflare Workers + D1，0 維護、即時推播。
...
若不使用 AI，可刪除 ai-config.ts 與 parseReminder 中的 AI fallback。
...
| ------------------------------------------------------------- | ------------------------------------------------------------- | ------------------------------------------------------------- |
| ![建立排程](./%E6%88%AA%E5%9C%96%202025-06-19%2002.10.27.png) | ![修改排程](./%E6%88%AA%E5%9C%96%202025-06-19%2002.10.50.png) | ![觸發推播](./%E6%88%AA%E5%9C%96%202025-06-19%2002.23.56.png) |
